...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-row flex-wrap items-center gap-2 md:gap-6 p-4 md:p-6 bg-background/90 dark:bg-background/80 backdrop-blur border-b border-border">
      <AccessibilityToggle />
      <ThemeToggle />
      <LanguageSelector />
      {user && (
