...
/**
 * CommunityIntelligenceSection (archived)
 * This section is preserved for future use. Not shown in the current UI.
 */
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground mb-6">
              ...
              Community-wide intelligence.
            </span>
            <h2 className="text-4xl lg:text-6xl font-display tracking-tight mb-8">
              Community-wide intelligence.
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Monitor every sensor, package, and maintenance request in real-time across your entire portfolio.
            </p>
