...
export function SignalsSection() {
  ...
  return (
    <section id="insights" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      <div
        ref={cursorRef}
        className={cn(
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">PRODUCT HIGHLIGHTS</h2>
      </div>
