...
const securityFeatures = [
  {
    icon: Shield,
    title: "Biometric Key Tracking (KeyLink)",
    description: "Track and manage keys with biometric authentication for maximum security.",
  },
  {
    icon: Lock,
    title: "Vendor Compliance Monitoring",
    description: "Monitor and enforce vendor compliance with automated checks and reporting.",
  },
  {
    icon: Eye,
    title: "GDPR & PIPEDA Compliant",
    description: "Full compliance with global privacy standards to protect resident data.",
  },
];
