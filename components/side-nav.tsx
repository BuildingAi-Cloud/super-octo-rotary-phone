...
export function SideNav() {
  ...
  return (
    <nav className="safe-top-pad fixed left-0 top-0 z-50 h-screen w-16 md:w-20 hidden md:flex flex-col justify-center border-r border-border/30 bg-background/80 backdrop-blur-sm">
